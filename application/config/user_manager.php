...
//email settings
$config['um_email_from'] = 'registracion@divariusapp.com';
$config['um_email_from_name']= 'Bienvenido a Divarius';
$config['um_email_activate_subject'] = 'Active su cuenta';
$config['um_email_reset_subject'] = 'Necesita establecer nuevamente su contraseña?';
