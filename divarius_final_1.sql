...
insert  into `categoria_habitaciones`(`id`,`nombre`,`id_establecimiento`) values (1,'Single',1),(2,'Doble',1),(3,'Suite Junior2',1),(4,'Suite',1),(5,'Presidencial',2),(9,'Presidencial',1);
