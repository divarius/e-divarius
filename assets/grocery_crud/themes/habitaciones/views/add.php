...
?>
	<!-- CONTENT FOR ALERT MESSAGES -->
            ...
            <?php
            echo form_open( $insert_url, 'method="post" id="crudForm" class="habitacionABM" autocomplete="off" enctype="multipart/form-data"');
            ?>
                <div id="abmTop" class="row controls">
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="span6">
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="roundedThree">
                                            <input id='rounded1'  value="1" type="checkbox" name="resortactive"/>
                                            <label for="rounded1"></label>
                                            <p class="checkbox-title">Habilitada</p>
                                        </div>
                                        <div class="roundedThree">
                                            <input type="checkbox" value="1" id="rounded2" name='online_resort'/>
