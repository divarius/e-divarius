		...
		<div id="abmTop" class="row">
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="span4">
                                <div class="row-fluid">
                                    <div class="span4"><?php echo dashMenu(); ?></div>
                                    <div class="span8"><h2><?php echo $subject?>es</h2></div>
                                </div>    
                            </div>
                            <div class="span8 content-gral-nav">
                                <div class="pull-right">
                                   <div id="options-content">		
                                   <?php
                                    if(!$unset_add || !$unset_export || !$unset_print){?>
                                            <?php if(!$unset_add){?>
                                                    <a href="<?php echo $add_url?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject?>" class="midium-btn blue-btn new">
                                                            <?php echo $this->l('list_add'); ?> <?php echo $subject?>
                                                    </a>
                                            <?php
                                            }
                                            if(!$unset_export) { ?>
                                                    <a class="midium-btn blue-btn export-anchor" data-url="<?php echo $export_url; ?>" rel="external">
                                                            <?php echo $this->l('list_export');?>
                                                    </a>
                                            <?php
                                            }
                                            if(!$unset_print) { ?>
                                                    <a class="midium-btn blue-btn print-anchor" data-url="<?php echo $print_url; ?>">
                                                            <?php echo $this->l('list_print');?>
                                                    </a>
                                            <?php
                                            }
                                    } ?>
                                    <a class="midium-btn blue-btn" data-toggle="modal" href="#filtering-form-search" >
		...
		<!-- CONTENT FOR ALERT MESSAGES -->
                ...
                <div class="row">
                    <div class="pGroup span12">
                        <div class="row-fluid">
                            <div class="span6">
                                <select name="tb_per_page" id="tb_per_page" class="chosen-select">
                                ...
                                <span class="pcontrol pull-right">
